...
// import { sendEmail } from "../utils/emailService.js"; // Commenté si non utilisé

// ==================== AJOUTER "export" DEVANT CES FONCTIONS ====================

// Fonction utilitaire pour nettoyer les URLs d'images - VERSION DÉFINITIVE
export const cleanImageUrl = (url, type = "profile") => {  // AJOUTER "export"
  if (!url) {
    return null;
  }
...
export const getSafeProfileImage = (imageUrl) => {  // AJOUTER "export"
  if (!imageUrl) {
    return null;
  }
...
// Login utilisateur
export const login = async (req, res) => {  // "export" déjà présent
  try {
    const { email, mot_de_passe } = req.bgindy;
