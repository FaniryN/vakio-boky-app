...
//   try {
//     console.log("🟡 Début de getAllLandingData");
...
//       // Auteurs promus - Utilisateurs avec is_promoted = true
//       pool.query(`
//         SELECT 
...
//           AND role IN ('auteur', 'editeur', 'admin')
...
//             pool.query("SELECT COUNT(*) FROM utilisateur WHERE is_promoted = true"),
...
//       name: author.nom,
//       bio: author.bio,
//       author_genre: author.author_genre,
//       published_works: author.published_works,
...
// // // GET témoignages (commentaires récents)
...
// //       image: author.profile_image,
// //       role: author.role,
// //       promoted_at: author.promoted_at
// //     }));
...
// // // GET événements récents (7 derniers jours)
...
// // // GET auteurs récemment promus
// // export const getRecentPromotedAuthors = async (req, res) => {
// //   try {
// //     const result = await pool.query(
// //       `SELECT 
// //         id, nom, bio, author_genre, 
...
// //     });
// //   } catch (error) {
// //     console.error('Error fetching recent promoted authors:', error);
// //     res.status(500).json({ 
// //       success: false,
// //       message: 'Erreur lors de la récupération des auteurs récemment promus',
// //       error: error.message 
// //     });
// //   }
// // };
