...
//     // Filter by search term (order ID or customer)
//     if (searchTerm) {
...
//               return {
//                 ...order,
//                 customer_name: userData.success ? userData.user.nom : `Utilisateur ${order.user_id}`,
//               };
//             } catch {
//               return {
//                 ...order,
//                 customer_name: `Utilisateur ${order.user_id}`,
//               };
//             }
//           })
//         );
...
//         setOrders(orders.map(order =>
//           order.id === orderId
//             ? { ...order, status: newStatus, tracking_number: trackingNumber }
//             : order
//         ));
...
//       } else {
//         alert(data.error || "Erreur lors de la création du litige");
//       }
//     } catch (err) {
...
//                               if (reason) {
//                                 createDispute(order.id, reason, "Litige créé par l'administrateur");
//                               }
//                             }}
...
//                     <p className="text-sm text-gray-900">Utilisateur #{selectedOrder.user_id}</p>
//                   </div>
//                   <div>
