  ...
  useEffect(() => {
    const fetchLivres = async () => {
      try {
        ...
        // SI TOUT ÉCHOUE, utiliser des données mock avec images locales
        console.log("⚠️ Utilisation de données de démonstration");
        setLivres([
          {
            id: 1,
            titre: "Ny Onja",
            description: "Roman poétique sur la vie à Madagascar",
            couverture_url: "/assets/images/books/ny-onja.jpg",
            genre: "Roman",
            auteur: "Johary Ravaloson"
          },
          {
            ...
            titre: "Dernier Crépuscule",
            description: "Histoire d'une famille malgache",
            couverture_url: "/assets/images/books/crepuscule.jpg",
            genre: "Roman",
            auteur: "Michèle Rakotoson"
          },
          {
            ...
            titre: "Contes de Madagascar",
            description: "Contes traditionnels malgaches",
            couverture_url: "/assets/images/books/contes.jpg",
            genre: "Contes",
            auteur: "Collectif"
          }
        ]);
            ...
            {livres.length > 0 ? (
              livres.slice(0, 6).map((livre, index) => (
                ...
                >
                  <div className="relative overflow-hidden h-64">
                    <img
                      src={livre.couverture_url || livre.cover || "/assets/images/books/book-default.jpg"}
                      alt={livre.titre || "Livre"}
                      className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                      onError={(e) => {
                        e.target.onerror = null;
