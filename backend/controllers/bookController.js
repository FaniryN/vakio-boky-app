...
// GET /api/books/recent - Récupérer les livres récents (CORRIGÉ)
export const getRecent = async (req, res) => {
  console.log('📚 Controller: getRecent appelé');
  
  try {
    // D'ABORD ESSAYER DE RÉCUPÉRER DE LA BASE DE DONNÉES
    const limit = parseInt(req.query.limit) || 5;
    ...
    // FALLBACK: DONNÉES MOCKÉES SI LA BASE EST VIDE
      ...
      books: [
        {
          ...
          couverture_url: "https://via.placeholder.com/400x600/718096/FFFFFF?text=Livre+Test",
